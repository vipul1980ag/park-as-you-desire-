...
function createStyles(T) {
  return StyleSheet.create({
    ...
    botBadgeText: { fontSize: 20, fontWeight: '900', color: '#ffffff' },
    ...
    userText: { fontSize: 15, color: '#ffffff', fontWeight: '600', lineHeight: 21 },
    ...
    typingDot: { width: 8, height: 8, borderRadius: 4, backgroundColor: T.textMuted },
    ...
    quickRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, paddingTop: 10, paddingHorizontal: 4 },
    quickChip: {
